...
namespace OpenVN.Application
{
    public class CreateUserCommandHandler : BaseCommandHandler, IRequestHandler<CreateUserCommand, string>
    {
        ...
        public CreateUserCommandHandler(IEventDispatcher eventDispatcher, IAuthService authService, IUserReadOnlyRepository userReadOnlyRepository, IUserWriteOnlyRepository userWriteOnlyRepository, IStringLocalizer<Resources> localizer) : base(eventDispatcher, authService)
        {
